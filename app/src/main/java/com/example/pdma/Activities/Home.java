package com.example.pdma.Activities;
...
import com.example.pdma.R;

public class Home extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    Button btn_covidReport, btn_notification, btn_call, btn_weather;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_covidReport = findViewById(R.id.id_btn_covid_report);
        btn_notification = findViewById(R.id.id_btn_notification);
        btn_call = findViewById(R.id.id_btn_call);
        btn_weather = findViewById(R.id.id_btn_weather);

        btn_covidReport.setOnClickListener(new View.OnClickListener() {
            @Override
